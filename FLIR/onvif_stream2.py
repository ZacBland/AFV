...
if not cap.isOpened():
    ...
    while True:
        ...
        if ret:
            ...
            # Convert the thresholded image to a pseudo-color image for visualization
            thresholded = cv2.convertScaleAbs(thresholded)  # Convert to uint8
            thermal_image = cv2.applyColorMap(thresholded, cv2.COLORMAP_HOT)
