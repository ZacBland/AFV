"""
https://github.com/winstxnhdw/FullStanleyController
"""
...
class StanleyController:
    ...
    def __init__(self, control_gain=2.5, speed_proportional_gain=1.0, softening_gain=1.0, yaw_rate_gain=0.0, steering_damp_gain=0.0,
                 max_steer=np.deg2rad(20), wheelbase=0.5, path_x=None, path_y=None, path_yaw=None):
        """
        Stanley Controller
        ...
        self.k = control_gain
        self.kp = speed_proportional_gain
